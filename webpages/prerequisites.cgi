...
sql_query = "SELECT * FROM prerequisites"
if search_query:
...
print("<html>")
print("<head>")
print("<title>Prerequisites Table</title>")
print("</head>")
print("<body>")
print("<h1>Prerequisites Table</h1>")
...
print("<option value='pc_prefix'>PC Prefix</option>")
print("<option value='pc_number'>PC Number</option>")
print("<option value='pc_code'>PC Code</option>")
print("</select>")
...
print("<th>Prefix</th>")
print("<th>Number</th>")
print("<th>PC Prefix</th>")
print("<th>PC Number</th>")
print("<th>PC Code</th>")
print("</tr>")
print("</thead>")
print("<tbody>")
